  ...
  return (
    <>
      <section id="home" className="hero">
        <div className="hero-content"><div className="heading">
          <h1>Hi, my</h1>
        ...
        <a href="#about" className="toAbout"><h2 className="btn btn-lg">Learn More</h2><i className="fa fa-arrow-down fa-2x"></i></a>
      </section>
